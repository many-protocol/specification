...
=== Defaults
By default, on account creation, the number of approval needed for any transaction will be the total number of users with the `"canApprove"` role (including `"owner"`).
