...
A server who receives a request with an attribute it does not recognize MUST automatically return an error with code `UnknownRequestAttribute` (-12) and a list of attributes that caused the error.
